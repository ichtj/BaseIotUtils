package top.keepempty.serialport;
...
public class SerialPortActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
        ...
        mSendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(sendTxt)){
                    Toast.makeText(SerialPortActivity.this,"请输入发送命令！",Toast.LENGTH_LONG).show();
                    return;
                }
                if (sendTxt.length() % 2 == 1) {
                    Toast.makeText(SerialPortActivity.this,"命令错误！",Toast.LENGTH_LONG).show();
                    return;
                }
