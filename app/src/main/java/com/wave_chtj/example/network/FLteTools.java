...
public class FLteTools {
    ...
    private static com.chtj.base_framework.network.FLteTools sInstance;
     ...
     * @return
     */
    public static com.chtj.base_framework.network.FLteTools instance() {
        if (sInstance == null) {
            synchronized (com.chtj.base_framework.network.FLteTools.class) {
                if (sInstance == null) {
                    sInstance = new com.chtj.base_framework.network.FLteTools();
                }
            }
        }
        return sInstance;
