...
Java_com_ichtj_basetools_camera_CameraJNI_nativeCapture(
...
Java_com_ichtj_basetools_camera_CameraJNI_nativeOpen(
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_ichtj_basetools_camera_CameraJNI_nativeStartPreview(
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_ichtj_basetools_camera_CameraJNI_nativeStopPreview(
        JNIEnv*, jobject, jlong handle) {
...
Java_com_ichtj_basetools_camera_CameraJNI_nativeRelease(
        JNIEnv* env, jobject, jlong handle) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_ichtj_basetools_camera_CameraJNI_nativeGetState(
        JNIEnv*, jobject, jlong handle) {
...
Java_com_ichtj_basetools_camera_CameraJNI_nativeIsRunning(
        JNIEnv*, jobject, jlong handle) {
