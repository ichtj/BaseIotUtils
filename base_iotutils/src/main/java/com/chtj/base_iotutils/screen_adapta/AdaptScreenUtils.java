package com.chtj.base_iotutils.screen_adapta;
...
public final class AdaptScreenUtils {
    ...
    public static int pt2Px(final float ptValue) {
        DisplayMetrics metrics = BaseIotTools.getContext().getResources().getDisplayMetrics();
    ...
    private static void applyDisplayMetrics(final Resources resources, final float newXdpi) {
        ...
        BaseIotTools.getContext().getResources().getDisplayMetrics().xdpi = newXdpi;
